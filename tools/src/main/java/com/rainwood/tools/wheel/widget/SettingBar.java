package com.rainwood.tools.wheel.widget;
...
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // 文字颜色设置
        setLeftColor(array.getColor(R.styleable.SettingBar_bar_leftColor, ContextCompat.getColor(getContext(), R.color.fontColor)));

package com.rainwood.sentlogistics.ui.widget;
...
/**
 * create by a797s in 2020/6/18 11:12
 *
 * @Description : 自定义的TableLayout、增加了一些动画效果
 * @Usage : 用法与TabLayout没什么不同
 **/
@ViewPager.DecorView
public class GlueTabLayout extends HorizontalScrollView {
    ...
    public GlueTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, R.styleable.TabLayout, defStyleAttr,
                R.style.Widget_Design_TabLayout, new int[]{R.styleable.TabLayout_tabTextAppearance});

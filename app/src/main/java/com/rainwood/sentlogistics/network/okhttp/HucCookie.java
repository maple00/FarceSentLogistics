...
import com.rainwood.sentlogistics.network.utils.DateUtils;
...
public class HucCookie {
    ...
    public void saveCookie(URL url, HttpURLConnection conn, int expires) {
        ...
        for (int i = 0; i < ListUtil.getSize(cookieList); i++) {
    ...
    public static List<Map<String, String>> getCookie(String host) {
        String cookieJson = DataStorage.with(BaseApplication.app).getString(host, "[]");
    ...
    private void persistenceCookie(String host, List<Map<String, String>> cookieList) {
        ...
        DataStorage.with(BaseApplication.app).put(host, cookieJson);
    }
    ...
    public static void remove(String host) {
        DataStorage.with(BaseApplication.app).put(host, "[]");
    }
